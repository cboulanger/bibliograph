...
qx.Class.define("bibliograph.ui.main.Toolbar",
{
  ...
  members : {
    __qxtCreateUI : function()
    {
      ...
      this.getApplication().getAccessManager().bind("authenticatedUser", loginButton, "visibility", {
        converter : function(v) {
          return v ? 'excluded' : 'visible'
        }
      });
      loginButton.addListener("execute", function(e) {
        this.getApplication().cmd("login");
      }, this);
      ...
      this.getApplication().getAccessManager().bind("authenticatedUser", logoutButton, "visibility", {
        converter : function(v) {
          return v ? 'visible' : 'excluded'
        }
      });
      logoutButton.addListener("execute", function(e) {
        this.getApplication().cmd("logout");
      }, this);
      ...
      this.getApplication().getAccessManager().getUserManager().bind("activeUser.fullname", qxToolBarButton1, "label", {
