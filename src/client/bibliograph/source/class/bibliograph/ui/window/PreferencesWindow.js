    ...
    __qxtCreateUI: function() {
      ...
      confMgr.addListenerOnce(
        ...
        function(e) {
          ...
          var defaultListItem = new qx.ui.form.ListItem(
      ...
      var dsController = new qx.data.controller.List(
        null,
        datasourceSelectBox,
        "label"
      );
      ...
      excludeFieldsTextArea.addListener(
        "changeValue",
        function(e) {
          var key = this.__datasourceExcludeFieldsKey;
      ...
      // Authenication mode
      var authModeLabel = new qx.ui.basic.Label(
      ...
      var item2 = new qx.ui.form.ListItem(
      ...
      var qxListItem2 = new qx.ui.form.ListItem(
        this.tr("Read-Only"),
        null,
        null
      );
