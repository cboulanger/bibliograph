...
class Confirm extends Alert
{
  ...
  {
    $this->yesButtonLabel = Yii::t('app',"Yes");
    $this->noButtonLabel = Yii::t('app',"No");
   ...
   * @var string
   */
  protected $yesButtonLabel = "Yes";
  public function setYesButtonLabel(string $value){$this->yesButtonLabel = $value; return $this;}

  /**
   * @var string
   */
  protected $noButtonLabel = "No";
  public function setNoButtonLabel(string $value){$this->noButtonLabel = $value; return $this;}
  ...
  {
    return parent::sendToClient(array_merge($properties,['yesButtonLabel','noButtonLabel', 'allowCancel']));
  }
