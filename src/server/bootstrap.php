...
file_exists(DOTENV_FILE) or die("Missing environment variable definition file at " . DOTENV_FILE);
defined("APP_BACKEND_DIR") or define("APP_BACKEND_DIR" , __DIR__);
defined("VENDOR_DIR") or define("VENDOR_DIR" , APP_BACKEND_DIR . "/vendor" );
file_exists(VENDOR_DIR . '/autoload.php') or die("Missing composer dependencies at " . VENDOR_DIR);
