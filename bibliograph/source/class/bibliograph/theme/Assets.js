...
#asset(qx/icon/${qx.icontheme}/16/mimetypes/application-pdf.png)
#asset(qx/icon/${qx.icontheme}/16/mimetypes/empty-x-encrypted.png)
#asset(qx/icon/${qx.icontheme}/16/mimetypes/font-x-generic.png)
#asset(qx/icon/${qx.icontheme}/16/mimetypes/text-ascii.png)
#asset(qx/icon/${qx.icontheme}/16/mimetypes/text-x-generic.png)
#asset(qx/icon/${qx.icontheme}/16/mimetypes/video-x-generic.png)
#asset(qx/icon/${qx.icontheme}/16/places/folder.png)
#asset(qx/icon/${qx.icontheme}/16/places/folder-new.png)
#asset(qx/icon/${qx.icontheme}/16/places/folder-open.png)
#asset(qx/icon/${qx.icontheme}/16/places/folder-remote.png)
#asset(qx/icon/${qx.icontheme}/16/places/services.png)
...
#asset(qx/icon/${qx.icontheme}/16/status/folder-open.png)
...
#asset(qx/icon/${qx.icontheme}/32/status/help-about.png)
