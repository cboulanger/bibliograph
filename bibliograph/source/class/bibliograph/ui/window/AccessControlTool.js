...
qx.Class.define("bibliograph.ui.window.AccessControlTool",
{
  ...
  members : {
    __qxtCreateUI : function()
    {
      ...
      var qxToolBarButton1 = new qx.ui.toolbar.Button(this.tr('Reload from filesystem'), "icon/22/actions/view-refresh.png", null);
      qxToolBarButton1.setIcon("icon/22/actions/view-refresh.png");
      qxToolBarButton1.setVisibility("hidden");
      qxToolBarButton1.setLabel(this.tr('Reload from filesystem'));
      //qxToolBar1.add(qxToolBarButton1);
      qx.core.Init.getApplication().getAccessManager().getPermissionManager().create("system.manage").bind("state", qxToolBarButton1, "visibility", {
      ...
      var qxToolBarButton2 = new qx.ui.toolbar.Button(this.tr('Export to filesystem'), "icon/22/actions/go-next.png", null);
      qxToolBarButton2.setIcon("icon/22/actions/go-next.png");
      qxToolBarButton2.setVisibility("hidden");
      qxToolBarButton2.setLabel(this.tr('Export to filesystem'));
      qxToolBar1.add(qxToolBarButton2);
      qx.core.Init.getApplication().getAccessManager().getPermissionManager().create("system.manage").bind("state", qxToolBarButton2, "visibility", {
        converter : qcl.bool2visibility
      });
      qxToolBarButton2.addListener("execute", function(e)
      {
        var sel = this.leftSelectBox.getSelection();
        if (sel.length) {
          this.getApplication().getRpcManager().execute("bibliograph.access", "exportAccessModelDialog", [sel[0].getModel().getValue()]);
        }
      }, this);
      qxToolBar1.addSpacer();
      var qxToolBarButton3 = new qx.ui.toolbar.Button(this.tr('Exit'), "icon/22/actions/application-exit.png", null);
      qxToolBarButton3.setIcon("icon/22/actions/application-exit.png");
      qxToolBarButton3.setLabel(this.tr('Exit'));
