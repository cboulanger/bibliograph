...
qx.Class.define("bibliograph.ui.window.AccessControlTool",
{
  ...
  members :
  {
    __qxtCreateUI : function()
    {
      ...
      var actWin = this;
      actWin.setCaption(this.tr('Access control tool'));
      actWin.setVisibility("visible");
      actWin.setWidth(800);

      // on appear
      actWin.addListener("appear", function(e)
      {
        this.center();
      ...
      actWin.setLayout(qxVbox1);

      // toolbar
      var qxToolBar1 = new qx.ui.toolbar.ToolBar();
      actWin.add(qxToolBar1);
...
//        if (sel.length) {
//          this.getApplication().getRpcManager().execute("bibliograph.access", "reloadAccessModelDialog", [sel[0].getModel().getValue()]);
//        }
//      }, this);
      ...
      addUserButton.addListener("execute", function(e){
        ...
        this.getApplication().getRpcManager().execute( "bibliograph.actool", "newUserDialog");
      }, this);
...
//      }, this);
      ...
      addDatasourceButton.addListener("execute", function(e){
        ...
        this.getApplication().showPopup(this.tr("Please wait ..."));
        this.getApplication().getRpcManager().execute("bibliograph.actool", "newDatasourceDialog");
      }, this);
      ...
      helpButton.addListener("execute", function(e){
        this.getApplication().showHelpWindow("access-control")
      }, this);
      ...
      exportButton.addListener("execute", function(e)
      {
        ...
        if (sel.length) {
          this.getApplication().getRpcManager().execute(
              "bibliograph.access", "exportAccessModelDialog",
      ...
      actWin.add(qxGroupBox1, { flex : 1 });

      var qxVbox2 = new qx.ui.layout.VBox(null, null, null);
      qxGroupBox1.setLayout(qxVbox2);

      // store for select box
      var selectBoxStore = new qcl.data.store.JsonRpc(null, "bibliograph.actool", null);
      ...
      // store for left list
      var leftListStore = new qcl.data.store.JsonRpc(null, "bibliograph.actool", null);
      ...
      var rightListStore = new qcl.data.store.JsonRpc(null, "bibliograph.actool", null);
      ...
      // store for tree
      var treeStore = new qcl.data.store.JsonRpc(null, "bibliograph.actool", null);
