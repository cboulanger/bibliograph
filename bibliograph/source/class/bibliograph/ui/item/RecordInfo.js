  ...
  members :
  {
    ...
    */
    ...
    reloadRecordInfo : function()
    {
      ...
      app.getRpcManager().execute("bibliograph.reference", "getRecordInfoHtml", [app.getDatasource(), modelId], function(data) {
    ...
    reloadFolderData : function()
    {
      ...
      app.getRpcManager().execute("bibliograph.reference", "getContainingFolderData", [app.getDatasource(), modelId], function(data) {
    ...
    removeFromFolder : function()
    {
      ...
      var handler = qx.lang.Function.bind(function(result) {
        if (result === true)
        {
          ...
          app.getRpcManager().execute("bibliograph.reference", "removeReferences", [app.getDatasource(), selectedFolders[0].id, null, [app.getModelId()]], function()
          {
            this.hidePopup();
            this.reloadFolderData();
          }, this);
