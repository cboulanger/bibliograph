 ...
 *
 */
qx.Class.define("bibliograph.plugin.csl.Plugin",
{
  ...
  members : {
    init : function()
    {
       ...
       */
      var formattedView = new bibliograph.plugin.csl.FormattedViewUi();
 ...
 * initialize plugin
 */
bibliograph.plugin.csl.Plugin.getInstance().init();
