 ...
 */
class bibliograph_plugin_fieldsExtensionExmpl_DatasourceModel
  extends bibliograph_model_AbstractDatasourceModel
{
 ...
 /**
   ...
   * @return \bibliograph_plugin_fieldsExtensionExmpl_DatasourceModel
   */
  ...
  public function init()
  {
    if ( parent::init() )
    {
      $this->registerModels( array(
        ...
        'folder'    => array(
          'class'       => "bibliograph_plugin_fieldsExtensionExmpl_FolderModel",
