  ...
  extends qcl_application_plugin_AbstractPlugin
{
  ...
  {
    bibliograph_plugin_fieldsExtensionExmpl_DatasourceModel::getInstance()->registerSchema();
  }
  ...
  {
    bibliograph_plugin_fieldsExtensionExmpl_DatasourceModel::getInstance()->unregisterSchema();
  }
}
?>