 ...
 * - php_yaz extension
 */
class bibliograph_plugin_z3950_DatasourceModel
  extends bibliograph_model_AbstractDatasourceModel
{
   ...
   * @return \bibliograph_plugin_z3950_DatasourceModel
   */
  ...
  public function init()
  {
    if ( parent::init() )
    {
      $this->registerModels( array(
        'record' => array(
          'model' => array(
            'class'       => "bibliograph_plugin_z3950_RecordModel"
          ),
          'controller' => array(
            'service'   => "bibliograph.plugin.z3950.Service"
          )
        ),
        'search'    => array(
          'model' => array(
