  ...
  extends qcl_application_plugin_AbstractPlugin
{
  ...
  protected $data = array(
     array(
      'name'  => "Z39.50 Plugin",
      'url' => 'resource/bibliograph/plugin/z3950/ImportWindow.js'
    ),
    array(
      'name'  => "Z39.50 Plugin",
      'url' => 'resource/bibliograph/plugin/z3950/ImportWindowUi.js'
    ),
    array(
      'name'  => "Z39.50 Plugin",
      'url' => 'resource/bibliograph/plugin/z3950/Plugin.js'
    )
  );
  ...
  public function install()
  {
    ...
    $z3950dsModel = bibliograph_plugin_z3950_DatasourceModel::getInstance();
  ...
  public function uninstall()
  {
    ...
    try
    {
      bibliograph_plugin_z3950_DatasourceModel::getInstance()->unregisterSchema();
    }
    catch( Exception $e ){}
  }
}
