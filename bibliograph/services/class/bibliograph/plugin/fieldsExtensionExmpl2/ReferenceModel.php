  ...
  extends bibliograph_model_ReferenceModel
{
   ...
   * @return bibliograph_plugin_fieldsExtensionExmpl2_Schema
   */
	function getSchemaModel()
	{
	  ...
	  if ( $schemaModel === null)
	  {
	    qcl_import( "bibliograph_plugin_fieldsExtensionExmpl2_Schema" );
	    $schemaModel = new bibliograph_plugin_fieldsExtensionExmpl2_Schema( $this );
	  }
	  return $schemaModel;
	}
}
