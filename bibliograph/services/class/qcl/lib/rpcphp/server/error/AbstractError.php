...
/**
 * Error code, value 9999: Unknown Error
 *
 ...
 * Changed from 0 to 9999 because "no network connection" error also has error code
 * 0 on the client, which makes it impossible to distiguish the two errors client-side
 */
define("JsonRpcError_Unknown",      9999);
