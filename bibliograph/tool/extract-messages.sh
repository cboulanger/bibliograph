...
for LOCALE_ID in $LOCALE_IDS; do
  ...
  SOURCE_DIR=../services/class/bibliograph
  LOCALE_DIR=../services/locale/C.UTF-8/LC_MESSAGES
  ...
  SOURCE_DIR=../services/class/qcl
  LOCALE_DIR=../services/class/qcl/locale/C.UTF-8/LC_MESSAGES
  touch $LOCALE_DIR/$DOMAIN.po
