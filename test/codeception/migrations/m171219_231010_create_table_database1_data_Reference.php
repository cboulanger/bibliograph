...
class m171219_231010_create_table_database1_data_Reference extends Migration
{
  public function safeUp()
  {
    ...
    $this->createTable('database1_data_Reference', [
    ...
    $this->execute("ALTER TABLE database1_data_Reference ADD FULLTEXT INDEX `fulltext` ($definition)");
  }

  public function safeDown()
  {
    $this->dropTable('database1_data_Reference');
  }
}
